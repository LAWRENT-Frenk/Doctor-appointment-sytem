         ...
         public function edit(Pharmacy $pharmacy)
{
    $doctors = Doctor::all();
    $patients = Patient::all();
    return view('pharmacies.edit', compact('pharmacy', 'doctors', 'patients'));
}

        public function edit_34(Pharmacy $pharmacy)
        {
            $pharmacies = Pharmacy::all();
            $doctors = Doctor::all();
            $patients = Patient::all();
         ...
         * @return \Illuminate\Http\Response
         */
        public function update_old(Request $request, Pharmacy $pharmacy)
        {
            $validator = Validator::make($request->all(), [
                'patient_id' => 'required|exists:patients,id',
                'contact' => 'required|string',
        ...
        public function update(Request $request, Pharmacy $pharmacy)
{
    ...
    return redirect()->route('pharmacies.index')->with('success', 'Hospital Pharmacy updated successfully.');
}
