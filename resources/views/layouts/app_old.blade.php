                    ...
                    <ul class="metismenu side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="{{ route('appointments.create') }}">Add</a>
                                </li>
                                <li>
                                    <a href="{{ route('appointments.index') }}">View</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="{{ route('doctors.index') }}">View</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="{{ route('pharmacies.create') }}">Add</a>
                                </li>
                                <li>
                                    <a href="{{ route('pharmacies.index') }}">View</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                ...
                                <li>
                                    <a href="{{ route('patients.index') }}">View</a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="{{ route('profile.index') }}">View</a>
                                </li>
                                <!-- <li>
                                    <a href="{{ route('patients.index') }}">Edit</a>
                                </li> -->
                            </ul>
                        </li>
                        ...
                        <li class="side-nav-item">
                            ...
                            <ul class="side-nav-second-level" aria-expanded="false">
                                <li>
                                    <a href="{{ route('reports.appointments') }}">Appointments</a>
                                </li>
                                <li>
                                    <a href="{{ route('reports.pharmacy') }}">Pharmacy</a>
                                </li>

                                <li>
                                    <a href="{{ route('reports.doctors') }}">Doctor</a>
                                </li>

                                <li>
                                    <a href="{{ route('reports.patients') }}">Patient</a>
                                </li>
                            </ul>
                        </li>
