...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="add-doctor-form" action="{{ route('doctors.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-xl-6">
...
function addDoctor() {
    // Get the form data
    let formData = new FormData(document.getElementById('add-doctor-form'));
    ...
    fetch('{{ route('doctors.store') }}', {
        ...
        .finally(() => {
            ...
            window.location.href = '{{ route('doctors.index') }}?message=success';
        });
}
